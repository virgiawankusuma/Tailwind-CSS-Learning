    ...
    <div className="px-6 py-4 rounded-lg border shadow-orange-200 shadow mb-6 max-w-lg mx-auto bg-white">
      <form>
        <label for="email">
          ...
          <input type="email" id="email" placeholder="Add email.." className="px-3 py-2 border shadow rounded w-full block text-sm focus:outline-none focus:ring-1 focus:ring-orange-300 invalid:text-orange-700 invalid:focus:ring-orange-700 invalid:focus:border-orange-700 peer"/>
